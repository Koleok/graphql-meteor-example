...
# Database: reviews
# Generation Time: 2016-02-01 04:09:06 +0000
# ************************************************************
...
INSERT INTO `hateful_reviews` (`id`, `text`, `reviewer_id`)
VALUES
	(1,' If it were thought that anything I wrote was influenced by Robert Frost, I would take that particular work of mine, shred it, and flush it down the toilet, hoping not to clog the pipes. and frame it, like in a really nice frame!',2),
	(2,'I can’t stand him. Nobody will think to ask because I’m supposedly jealous; but I out-sell him. I’m more popular than he is, and I don’t take him very seriously…oh, he comes on like the worker’s son, like a modern-day D.H. Lawrence, but he’s just another boring little middle-class boy hustling his way to the top if he can do it. I really like the guy. ',3),
	(3,'‘Paradise Lost’ is one of the books which the reader admires and lays down, and forgets to take up again. None ever wished it longer than it is. ',4),
